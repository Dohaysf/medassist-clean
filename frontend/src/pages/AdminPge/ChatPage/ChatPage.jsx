...
const ChatPage = () => {
  ...
  const handleSendMessage = useCallback(async (text = input) => {
    ...
    try {
      ...
      const data = await sendMessage(payload, currentSessionId);
  ...
  }, [input, sessionId, isTyping, speak]);
  ...
  const handleEmergency = useCallback(async () => {
    ...
    const confirmSend = window.confirm("⚠️ Confirmez-vous l'envoi d'une alerte d'urgence ?");
  ...
  return (
    <div className="chat-page">
      <div className="chat-topbar">
        <span className="chat-topbar-title">Consultation médicale (Admin)</span>
